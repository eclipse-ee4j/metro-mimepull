...
This project contains the source code, documentation, and tests for JAX-WS,
SAAJ, Web Services Interoperability Technologies (WSIT) and StAX extensions
implementations. It is a one-stop shop for all your web service needs, from the
simplest hello world web service to reliable, secured, and transacted web
service that involves .NET services.
